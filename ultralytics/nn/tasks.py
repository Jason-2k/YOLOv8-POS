...
from ultralytics.nn.modules.attention.TransXNet import OSRA
from ultralytics.nn.modules.convolution.PConv import C2f_PConv
from ultralytics.nn.modules.structure.SlimNeck import GSConv, VoVGSCSP
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in (C2f_PConv, GSConv, VoVGSCSP):
            c1, c2 = ch[f], args[0]
            if c2 != nc:
                c2 = make_divisible(min(c2, max_channels) * width, 8)
